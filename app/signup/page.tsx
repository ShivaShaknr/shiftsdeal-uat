...
import { Mail, Lock, Building2, User, ArrowRight, Loader2, AlertCircle, CheckCircle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      await signInWithGoogle('/venues', accountType);
    } catch (err: any) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/20 via-background to-background relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12">
          ...
          <p className="text-xl text-foreground-muted mb-8">
            Create your account and start booking or listing venues today.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-foreground-muted">
              ...
              <span><strong>Renters:</strong> Book venues for your corporate events</span>
            </div>
            <div className="flex items-center gap-3 text-foreground-muted">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                <Building2 className="w-5 h-5 text-primary" />
              </div>
              <span><strong>Owners:</strong> List and manage your venues</span>
            </div>
          </div>
        </div>
      </div>
            ...
            {accountType === 'owner' && (
              ...
              >
                <p className="text-sm text-primary">
                  <strong>As a Venue Owner:</strong> You can list your venues, manage bookings, and earn money from your spaces.
                </p>
              </motion.div>
            )}
