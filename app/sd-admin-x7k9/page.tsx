    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-foreground">Bookings Management</h2>
          <button
                ...
                {filteredBookings.map(booking => (
                  <tr key={booking.id} className={cn(
                    ...
                    <td className="py-3 px-4">
                      ...
                      <p className="text-xs text-foreground-muted">{booking.date}</p>
                    ...
                    <td className="py-3 px-4">
                      ...
                      <p className="text-xs text-foreground-muted">{booking.contact_phone}</p>
                    </td>
                    <td className="py-3 px-4">
