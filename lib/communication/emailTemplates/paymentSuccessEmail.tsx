...
export function paymentSuccessEmail({
  ...
  return `
    ...
    <div style="max-width:650px;margin:0 auto;background:#ffffff;overflow:hidden;border:1px solid #e5e7eb;box-shadow:0 8px 24px rgba(0,0,0,0.06);">
      ...
      <!-- Header -->
      <div style="background:linear-gradient(135deg,#0f7a2f,#16a34a);padding:28px 20px;color:#ffffff;">
      ...
      <div style="padding:20px;">
         <img src="https://www.shiftsdeal.com/_next/image?url=%2Flogo-light.png&w=256&q=75" style="width:120px"/>
       ...
       <!-- Amount Box -->
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;padding:22px 20px;margin-bottom:24px;text-align:center;">
          <div style="display:inline-block;background:#dcfce7;color:#166534;font-size:10px;font-weight:700;letter-spacing:0.6px;text-transform:uppercase;padding:6px 12px;margin-bottom:12px;">
            Amount Paid
          </div>
        ...
        <div style="border:1px solid #e5e7eb;overflow:hidden;margin-bottom:24px;">
          <div style="display:flex;padding:14px 18px;background:#f9fafb;border-bottom:1px solid #e5e7eb;">
            ...
            <div style="width:58%;font-size:11px;color:#111827;font-weight:600;">${eventName || "-"}</div>
          </div>
          ...
          <div style="display:flex;padding:14px 18px;border-bottom:1px solid #e5e7eb;">
            ...
            <div style="width:58%;font-size:11px;color:#111827;font-weight:600;word-break:break-all;">${razorpayPaymentId || "-"}</div>
          </div>

          <div style="display:flex;padding:14px 18px;background:#f9fafb;">
            <div style="width:42%;font-size:11px;color:#6b7280;">Order ID</div>
            <div style="width:58%;font-size:11px;color:#111827;font-weight:600;word-break:break-all;">${razorpayOrderId || "-"}</div>
          </div>
        </div>

        <div style="background:#f9fafb;padding:16px;margin-bottom:24px;">
          <p style="font-size:11px;line-height:1.6;color:#4b5563;margin:0;">
