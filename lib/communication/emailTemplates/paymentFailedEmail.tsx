export function paymentFailedEmail({
    ...
    <div style="max-width:650px;margin:0 auto;background:#ffffff;overflow:hidden;border:1px solid #e5e7eb;box-shadow:0 8px 24px rgba(0,0,0,0.06);">
      ...
      <!-- Failed Header -->
      <div style="background:linear-gradient(135deg,#991b1b,#dc2626);padding:28px 32px;color:#ffffff;">
      ...
      <div style="padding:32px;">
        ...
        <div style="background:#fef2f2;border:1px solid #fecaca;padding:22px 20px;margin-bottom:24px;text-align:center;">
          <div style="display:inline-block;background:#fee2e2;color:#991b1b;font-size:12px;font-weight:700;letter-spacing:0.6px;text-transform:uppercase;padding:6px 12px;margin-bottom:12px;">
            Payment Amount
          </div>

          <div style="font-size:30px;line-height:1.2;color:#dc2626;font-weight:800;margin:0;">
            ₹${amount ? amount / 100 : 0}
          </div>
        ...
        <div style="border:1px solid #e5e7eb;overflow:hidden;margin-bottom:24px;">
          ...
          <div style="display:flex;padding:14px 18px;background:#f9fafb;">
            <div style="width:42%;font-size:14px;color:#6b7280;">Reason</div>
            <div style="width:58%;font-size:14px;color:#111827;font-weight:600;">
        ...
        <div style="background:#fff7ed;border:1px solid #fed7aa;padding:16px;margin-bottom:24px;">
          <p style="font-size:14px;line-height:1.6;color:#9a3412;margin:0;">
