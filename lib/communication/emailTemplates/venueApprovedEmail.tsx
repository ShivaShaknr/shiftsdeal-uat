          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
              ...
              <td align="right" style="vertical-align:top;width:120px;">
                <span style="display:inline-block;background:#dcfce7;color:#166534;font-size:12px;font-weight:800;letter-spacing:0.6px;text-transform:uppercase;padding:7px 12px;">
                  Approved
                </span>
              </td>
            </tr>
      ...
      <div style="padding:32px;">
        ...
        <div style="border:1px solid #e5e7eb;overflow:hidden;margin-bottom:24px;">
          ...
          <div style="display:flex;padding:14px 18px;background:#f9fafb;">
            ...
            <div style="width:58%;font-size:14px;color:#111827;font-weight:700;">
              Approved
            </div>
          </div>
        </div>
